...
const uint64_t MONEY_SUPPLY                                  = unit64_c(50000000);
...
const uint64_t DIFFICULTY_TARGET                             = 105; // seconds
...
const char     CRYPTONOTE_NAME[]                             = MergeCoin"";
...
const int      P2P_DEFAULT_PORT                              = 4444;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 4664;
